# Analytics Event Tracking — camdill.com `/learn`
...
| --- | --- | --- |
| `{slug}_cta_click` | Click on the article's primary CTA button (to a teamdill.com funnel) | `funnel`, `href` |
...
**CTA clicks to teamdill.com funnels**
...
Every link from camdill.com to a teamdill.com funnel is tagged with the campaign
...
```
https://teamdill.com/heloc?utm_source=camdill&utm_medium=learn_article&utm_campaign=ai_search_visibility
```
