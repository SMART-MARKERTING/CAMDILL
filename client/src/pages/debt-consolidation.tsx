          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="bg-neutral-50 rounded-lg p-6 mt-6">
                <h3 className="font-semibold text-neutral-900 mb-4">Current Debt Summary</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-neutral-700">Total Debt Balance</p>
                    <p className="text-2xl font-bold text-neutral-900">
                      ${getTotalBalance().toLocaleString()}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-neutral-700">Total Monthly Payments</p>
                    <p className="text-2xl font-bold text-neutral-900">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Button
              onClick={goToContact}
              variant="outline"
              className="border-2 border-white/30 bg-transparent text-white hover:bg-neutral-900 px-8 py-3"
            >
          ...
          <div className="mt-12 text-center">
            ...
            <p className="text-xs text-white opacity-80 leading-relaxed max-w-3xl mx-auto">
              ...
              Rates, terms, and conditions are subject to change without notice. Cameron Dill NMLS #763991. Adaxa Home NMLS #2380533.
            </p>
          </div>
        </div>
      </section>
