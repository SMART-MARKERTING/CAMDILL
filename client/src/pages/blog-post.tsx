    ...
    return (
      <div className="min-h-screen bg-black">
        ...
        <div className="container max-w-md mx-auto px-4 pt-24 text-center">
          ...
          <Link href="/blog">
            <Button className="bg-white hover:bg-[#0099bb] text-white">Back to Blog</Button>
          </Link>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="container max-w-md mx-auto px-4 pt-24 pb-6">
        ...
        {/* Back */}
        <Link href="/blog" className="inline-flex items-center gap-1 text-white/55 hover:text-white text-sm mb-6 transition-colors">
        ...
        <div className="flex items-center gap-3 mb-6 pb-6 border-b border-white/10">
          ...
          />
          <div>
            <p className="text-white text-sm font-semibold">Cameron Dill, NMLS #763991</p>
        ...
        <div className="bg-white/10 border border-white/20 rounded-xl p-6 text-center">
          ...
          <Button
            onClick={openCal}
            className="w-full bg-white hover:bg-[#0099bb] text-white font-semibold mb-3"
          >
            Schedule a Call
          </Button>
          <div className="flex gap-x-4 justify-center text-xs">
            <a
              ...
              className="text-white/55 hover:text-white underline transition-colors"
            >
              Apply for HELOC →
            </a>
            <a
