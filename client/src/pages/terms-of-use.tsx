  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="container max-w-3xl mx-auto px-4 pt-24 pb-12">
        ...
        <div className="bg-white/10 border border-white/20 rounded-xl p-6 md:p-8 space-y-8 text-white/80 text-sm leading-relaxed">
          <p>
            These Terms of Use govern your access to and use of <strong className="text-white">camdill.com</strong> (the &ldquo;Site&rdquo;), operated by <strong className="text-white">Cameron Dill at Adaxa Home</strong> (&ldquo;we,&rdquo; &ldquo;us,&rdquo; &ldquo;our&rdquo;) as the public web presence for Cameron Dill (NMLS #763991), a Senior Vice President - Retail affiliated with Adaxa Home LLC (NMLS #2380533). Mortgage services referenced on this Site are provided through Adaxa Home LLC. By using this Site, you agree to these Terms. If you do not agree, please do not use the Site.
          </p>
          ...
          <section>
            ...
            <p>
              We may restrict, suspend, or terminate your access to the Site at any time, without notice. The Site is intended for users located in jurisdictions where Cameron Dill and Adaxa Home LLC are authorized to offer mortgage-related services. As of the effective date above, this includes the following states: Arizona, California, Colorado, Connecticut, Florida, Idaho, Pennsylvania, Texas, Virginia, and Washington. You are responsible for complying with the laws and regulations of your jurisdiction.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 text-white">
              📞 <a href="tel:+18054150275" className="underline hover:text-white/70">805-415-0275</a>
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>
              When you provide a phone number through a form on this Site and check the consent box, you give your express written consent (opt-in) to receive recurring SMS/MMS messages from Cameron Dill at Adaxa Home, sent from{" "}
              <a href="tel:+18054150275" className="underline hover:text-white/70">805-415-0275</a>, regarding:
            </p>
          ...
          <section>
            ...
            <p>
              ...
              <a href="/privacy" className="underline hover:text-white/70">Privacy Policy</a>. We do not sell personal information.{" "}
