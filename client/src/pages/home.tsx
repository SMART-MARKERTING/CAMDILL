...
export default function Home() {
  ...
  const loanTypes = [
    {
      ...
      href: "https://teamdill.com/purchase?utm_source=camdill&utm_medium=hub&utm_campaign=purchase-card",
    },
    {
      ...
      href: "https://teamdill.com/cash-out?utm_source=camdill&utm_medium=hub&utm_campaign=refinance-card",
    },
    {
      ...
      href: "https://teamdill.com/heloc-main?utm_source=camdill&utm_medium=hub&utm_campaign=heloc-card",
    },
  ];
  ...
  const trustPoints = [
    ...
    },
    {
      ...
      items: [
        "20+ years in lending — relationship-based service",
  ...
  const socialLinks = [
    {
      title: "TEAMDILL",
      url: "https://teamdill.com",
      icon: <ExternalLink className="h-5 w-5" />,
      color: "bg-white/10 hover:bg-white/15 border border-white/20",
    },
    {
      title: "Book",
      url: "https://cal.com/cdill/15min",
      icon: <Calendar className="h-5 w-5" />,
      color: "bg-white/10 hover:bg-white/15 border border-white/20",
    },
    {
      title: "Email",
      url: "mailto:Cdill@adaxahome.com",
      icon: <Mail className="h-5 w-5" />,
      color: "bg-white/10 hover:bg-white/15 border border-white/20",
    },
    {
      title: "Apply",
      url: "https://teamdill.com/see-my-options",
    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="container max-w-md mx-auto px-4 pt-20 pb-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white font-semibold text-base mb-1 tracking-wide uppercase">
          ...
          <div className="inline-block bg-white/10 border border-white/20 rounded-full px-4 py-1.5">
            <p className="text-white/70 text-xs font-medium">
              NMLS #763991 &nbsp;|&nbsp; Adaxa Home LLC NMLS #2380533
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3 mb-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <Card className="bg-white hover:bg-neutral-200 border-0 shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 h-full">
                <CardContent className="p-4 flex flex-col items-start gap-1">
                  <TrendingUp className="h-5 w-5 mb-1 text-black" />
                  <p className="font-bold text-sm leading-tight text-black">Apply for HELOC</p>
                  <p className="text-black/70 text-xs">Tap your home equity</p>
                </CardContent>
              </Card>
            </a>
            <div className="flex flex-col gap-1.5">
              ...
              >
                <Card className="bg-white hover:bg-neutral-200 border-0 shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 h-full">
                  <CardContent className="p-4 flex flex-col items-start gap-1">
                    <RefreshCw className="h-5 w-5 mb-1 text-black" />
                    <p className="font-bold text-sm leading-tight text-black">Apply for Refinance</p>
                    <p className="text-black/70 text-xs">Cash-out or rate reduction</p>
                  </CardContent>
                </Card>
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block text-center text-white/45 hover:text-white/70 text-xs transition-colors underline"
              >
          ...
          >
            ...
            <span className="text-sm">20+ years · lending experience</span>
          </a>
        </div>
              ...
              >
                <div className="bg-white/10 hover:bg-white/15 border border-white/20 hover:border-white/40 hover:shadow-[0_0_16px_rgba(255,255,255,0.08)] rounded-xl p-4 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.99]">
                  <div className="flex items-start space-x-4">
                    <div className="text-white mt-0.5 flex-shrink-0">{loan.icon}</div>
                    <div>
                      <h3 className="text-white font-semibold text-base mb-1">{loan.title}</h3>
                      <p className="text-white/70 text-sm leading-relaxed">{loan.description}</p>
                    </div>
                  </div>
                </div>
              </a>
        ...
        {/* ── Trust Section ── */}
        <div className="mb-8">
          <h2 className="text-white text-xl font-bold text-center mb-5">Why Cameron?</h2>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 mb-6">
          ...
          <div className="space-y-3 mb-4">
            ...
            >
              ...
              <span>Cdill@adaxahome.com</span>
            </a>
          </div>
          <div className="text-center text-white/55 text-xs leading-relaxed">
          ...
          <div className="bg-slate-900 border border-white/20 rounded-2xl shadow-2xl max-w-sm w-full p-6 relative">
            ...
            <form onSubmit={handleApplySubmit} className="space-y-4">
              <Input
                ...
                className="bg-white/10 border-white/30 text-white placeholder:text-white/40 focus:border-white focus:ring-white"
                required
                autoFocus
              />
              <Button
                ...
                className="w-full bg-white hover:bg-neutral-200 text-black font-semibold py-3"
              >
                Continue to Application
              </Button>
            </form>

            <p className="text-white/45 text-xs text-center mt-4 leading-relaxed">
