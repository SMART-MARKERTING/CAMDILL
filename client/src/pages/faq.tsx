  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "I've been in mortgage for 7+ years, holding the NMLS license since early in my career. I'm currently a Senior Vice President - Retail at Adaxa Home LLC, working with a network of 99+ wholesale lenders.",
      },
      {
      ...
      <div className="container max-w-md mx-auto px-4 pt-24 pb-6">
        <div className="text-center mb-10">
          ...
          <p className="text-white/55 text-sm">
            Plain answers to common mortgage questions from Cameron Dill
          </p>
        </div>
        ...
        {/* CTA */}
        <div className="mt-10 bg-white/10 border border-white/20 rounded-xl p-6 text-center">
          ...
          <Button
            onClick={openCal}
            className="bg-white hover:bg-[#0099bb] text-white font-semibold px-6"
          >
