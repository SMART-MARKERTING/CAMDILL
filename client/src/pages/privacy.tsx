      ...
      <div className="container max-w-3xl mx-auto px-4 pt-24 pb-12">
        ...
        <div className="bg-white/10 border border-white/20 rounded-xl p-6 md:p-8 space-y-8 text-white/80 text-sm leading-relaxed">
          <section>
            ...
            <p>
              This Privacy Policy explains how <strong className="text-white">Cameron Dill at Adaxa Home</strong> (&ldquo;we,&rdquo; &ldquo;us,&rdquo; &ldquo;our&rdquo;) collects, uses, and protects information through{" "}
              <strong className="text-white">camdill.com</strong> (the &ldquo;Site&rdquo;), the public web presence for Cameron Dill (NMLS #763991), Senior Vice President - Retail affiliated with Adaxa Home LLC (NMLS #2380533). Mortgage services referenced on this Site are provided through Adaxa Home LLC.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>
              When you submit a phone number through a form on this Site and check the consent box, you give your express written consent to receive SMS/MMS messages from Cameron Dill at Adaxa Home. SMS messages from this campaign are sent from{" "}
              <a href="tel:+18054150275" className="underline hover:text-white/70">805-415-0275</a>. Examples of message content include:
            </p>
            <ul className="list-disc list-inside mt-2 space-y-1 ml-2">
            ...
            <p className="mt-3">
              SMS is used for service-related, transactional, and (where you have opted in) marketing communications from Cameron Dill at Adaxa Home.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <a href="mailto:Cdill@adaxahome.com" className="underline hover:text-white/70">
                Cdill@adaxahome.com
              </a>{" "}
              or call{" "}
              <a href="tel:+18054150275" className="underline hover:text-white/70">
                805-415-0275
              </a>
              .
            </p>
