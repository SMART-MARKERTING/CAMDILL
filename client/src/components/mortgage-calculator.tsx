    ...
    <section id="calculator" className="py-16 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Mortgage Calculator</h2>
          <p className="text-lg text-gray-600">Calculate your monthly payments with transparency and professional service</p>
        </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-start">
          ...
          <div className="mt-8 lg:mt-0">
            <Card className="bg-neutral-50 border-2 border-neutral-200">
              <CardHeader>
                <CardTitle className="text-neutral-900">Payment Results</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center py-4 bg-neutral-50 rounded-lg px-4 border-2 border-white/30">
                ...
                {(inputs.propertyTax > 0 || inputs.propertyInsurance > 0) && (
                  <>
                    ...
                    <div className="flex justify-between items-center py-3 bg-neutral-100 rounded-lg px-4 border-2 border-neutral-300">
