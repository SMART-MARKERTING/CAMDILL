        ...
        <CardContent className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  {inputs.extraPayment > 0 && (
                    <Button
                      ...
                      size="sm"
                      variant="ghost"
                      className="absolute right-1 top-1/2 transform -translate-y-1/2 h-8 px-2 text-gray-500 hover:text-neutral-700"
                    >
                      Clear
                    </Button>
                  )}
            ...
            <div className="bg-neutral-50 rounded-lg p-6">
              <h3 className="font-semibold text-neutral-900 mb-4">Consolidation Loan Results</h3>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-neutral-700">Principal & Interest:</span>
                  <span className="font-bold text-neutral-900">${results.monthlyPayment.toLocaleString()}</span>
                </div>
                ...
                {(inputs.propertyTax > 0 || inputs.propertyInsurance > 0) && (
                  <>
                    ...
                    <div className="flex justify-between border-t pt-2">
                      <span className="text-neutral-700 font-medium">Total Monthly Payment:</span>
                      <span className="font-bold text-neutral-900">${(results.monthlyPayment + inputs.propertyTax + inputs.propertyInsurance).toLocaleString()}</span>
                    </div>
                  </>
                )}
                <div className="flex justify-between border-t pt-2">
                  <span className="text-neutral-700">Current Total Payments:</span>
                  <span className="font-bold text-neutral-900">${totalMonthlyPayments.toLocaleString()}</span>
                </div>
                ...
                {inputs.extraPayment > 0 && (
                  <>
                    <div className="flex justify-between">
                      <span className="text-neutral-700">Total with Extra Payments:</span>
                      <span className="font-bold text-neutral-900">${results.totalPaymentsWithExtra.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-neutral-700">Payoff Time (with extra):</span>
                      <span className="font-bold text-neutral-900">{Math.round(results.payoffTime)} months</span>
                    </div>
                  </>
                )}
              </div>
      ...
      <Card className="bg-gradient-to-r from-green-50 to-blue-50">
        ...
        <CardContent className="space-y-6">
          <div className={`grid gap-6 ${inputs.extraPayment > 0 ? 'md:grid-cols-3' : 'md:grid-cols-2'}`}>
            ...
            <div className="text-center p-4 bg-white rounded-lg shadow-sm">
              <DollarSign className="w-8 h-8 mx-auto text-neutral-700 mb-2" />
